...
export default function SimpleSets({sets, movements}) {
    const movementsElements = movements.map((movement, index) => {
        console.log(movement, sets[index]);
            ...
            <Movement key={index}>
                ...
                <MovementRight>
                    <Input
                        type="number"
                        placeholder="reps"
                        value={sets[0][index].reps}
                    />
                    <div>x</div>
                    <Input
                        type="number"
                        placeholder="weight"
                        value={sets[0][index].weight}
                    />
                </MovementRight>
            </Movement>
        );
    ...
    return (
        <Wrapper>
            <WrapperLeft>{`${sets.length}x`}</WrapperLeft>
